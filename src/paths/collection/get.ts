...
export function getEndpoint(dataClass: IWakandaDataClass): Endpoint {
  ...
  endpoint.summary = `Get all ${dataClass.name} entities in the collection according to the given parameters`;
  ...
  endpoint.tags.push(dataClass.name, TagName.Collection);
